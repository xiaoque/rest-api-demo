...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, ProjectDto> projectProducerFactory(ObjectMapper objectMapper) {
        ...
        configProps.put("spring.json.value.type", "com.fr.demo.model.dto.ProjectDto");
        return new DefaultKafkaProducerFactory<>(configProps, new StringSerializer(),
                new CustomJsonSerializer<>(objectMapper));
    }

    @Bean
    public KafkaTemplate<String, ProjectDto> projectKafkaTemplate(
            ProducerFactory<String, ProjectDto> projectProducerFactory) {
